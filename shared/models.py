...
class Sectors(Base_Model):
    ...
    def get_sector(self, sector: str) -> str:
        ...
        health_care = set(['healthcareequipmentandservices', 'healthcareequipmentservices', 'pharmaceuticals,biotechnologyandlifesciences',
                           'pharmaceuticals,biotechnology,lifesciences', 'pharmaceuticals', 'biotechnology', 'pharmaceuticals', 'lifesciences', 'pharmaceutical', 'healthcare'])
        it = set(['technologyhardwareequipment', 'technology', 'hardware', 'semiconductorssemiconductorequipment',
                  'semiconductors', 'semiconductorequipment', 'informationtechnology', 'software', 'softwareservices'])
        comm_serv = set(['communicationservices', 'communicationservice',
                         'telecommunicationservices', 'mediaentertainment', 'media', 'entertainment'])
        comm_staples = set(['consumerstaples', 'consumerstaple', 'foodstaplesretailing', 'food', 'staples',
                            'householpersonalproducts', 'household', 'personalproducts', 'foodbeveragetobacco', 'foodbeverage', 'tobacco'])
        comm_disc = set(['consumerdiscretionary', 'automobilescomponents', 'automobiles',
                         'consumerservices', 'consumerdurablesapparel', 'apparel', 'consumerdurables', 'retailing'])
        indust = set(['industrials', 'industrial', 'commercialprofessional services',
                      'professionalservices', 'transportation', 'capitalgoods'])
        financ = set(['financials', 'financial', 'insurance',
                      'banks', 'bank', 'banking', 'diversifiedfinancials'])
...
class Fundamental_Indicators(Base_Model):
    ...
    def __init__(self):
        ...
        # already a percent dont convert
        self.data['institutional_ownership'] = self.default_float
        # already a percent dont convert
        self.data['short_interest_percent'] = self.default_float
