...
class DB_SCHEMA(object):
  ...
  def nostradamus_tables(self):
    ...
    "`eod_id` BIGINT(11) NOT NULL AUTO_INCREMENT,"
    ...
    "`weekly_id` BIGINT(11) NOT NULL AUTO_INCREMENT,"
    "`transaction_id` BIGINT(11) NOT NULL,"
    "`date` DATE NOT NULL,"
    "`open` FLOAT(14, 4),"
    "`high` FLOAT(14, 4),"
    ...
    "`news_event_id` BIGINT(11) NOT NULL AUTO_INCREMENT,"
    "`transaction_id` BIGINT(11) NOT NULL,"
    ...
    "`sec_id` BIGINT(11) NOT NULL AUTO_INCREMENT,"
    "`transaction_id` BIGINT(11) NOT NULL,"
    "`date_of_ipo` DATE,"
    "`late_filings` INT(11),"
    "`ct_orders` INT(11),"
    ...
    "`sec_company_info_id` BIGINT(11) NOT NULL AUTO_INCREMENT,"
    "`sec_id` BIGINT(11) NOT NULL,"
    "`date` DATE,"
    "`link` TEXT,"
    "`item_list` JSON,"
    ...
    "`sec_merger_id` BIGINT(11) NOT NULL AUTO_INCREMENT,"
    "`sec_id` BIGINT(11) NOT NULL,"
    "`date` DATE,"
    ...
    "`sec_employee_stock_id` BIGINT(11) NOT NULL AUTO_INCREMENT,"
    "`sec_id` BIGINT(11) NOT NULL,"
    "`date` DATE,"
    ...
    "`sec_secondary_offering_id` BIGINT(11) NOT NULL AUTO_INCREMENT,"
    "`sec_id` BIGINT(11) NOT NULL,"
    "`date` DATE,"
    "`additional_shares_issued` INT(11),"
    "`is_asr` BOOLEAN,"
    ...
    "`pearsons_coeff_close_spy_5_period` FLOAT(14, 4),"
    "`pearsons_coeff_close_spy_15_period` FLOAT(14, 4),"
    "`pearsons_coeff_close_spy_30_period` FLOAT(14, 4),"
    ...
    "`cost_of_revenue` DECIMAL(18, 4) ,"
    "`gross_profit` DECIMAL(18, 4) ,"
    "`r_and_d` DECIMAL(18, 4) ,"
    "`selling_gen_and_admin` DECIMAL(18, 4) ,"
    "`operating_expense` DECIMAL(18, 4) ,"
    "`operating_income` DECIMAL(18, 4) ,"
    "`other_income_expense_net` DECIMAL(18, 4) ,"
    "`ebit` DECIMAL(18, 4) ,"
    "`intrest_income` DECIMAL(18, 4) ,"
    "`pretax_income` DECIMAL(18, 4) ,"
    "`income_tax` DECIMAL(18, 4) ,"
    "`minority_intrest` DECIMAL(18, 4) ,"
    "`net_income` DECIMAL(18, 4) ,"
    "`net_income_basic` DECIMAL(18, 4) ,"
    "`company_name` TINYTEXT,"
    "`yr_high` DECIMAL(18, 4) ,"
    "`yr_low` DECIMAL(18, 4) ,"
    "`yr_change` DECIMAL(18, 4) ,"
    "`shares_outstanding` DECIMAL(18, 4) ,"
    "`shares_float` DECIMAL(18, 4) ,"
    "`eps_ttm` DECIMAL(18, 4) ,"
    "`dividend_yield` DECIMAL(18, 4) ,"
    "`dividend_rate_ttm` DECIMAL(18, 4) ,"
    "`employees` DECIMAL(18, 4) ,"
    "`earnings_date` DATE,"
    "`pe_ratio` DECIMAL(18, 4) ,"
    "`beta` DECIMAL(18, 4) ,"
    "`total_cash` DECIMAL(18, 4) ,"
    "`current_debt` DECIMAL(18, 4) ,"
    "`ebitda` DECIMAL(18, 4) ,"
    "`revenue_per_share` DECIMAL(18, 4) ,"
    "`revenue_per_employee` DECIMAL(18, 4) ,"
    "`debt_to_equity` DECIMAL(18, 4) ,"
    "`profit_margin` DECIMAL(18, 4) ,"
    "`enterprise_value` DECIMAL(18, 4) ,"
    "`enterprise_value_to_rev` DECIMAL(18, 4) ,"
    "`price_to_sales` DECIMAL(18, 4) ,"
    "`price_to_book` DECIMAL(18, 4) ,"
    "`foward_pe_ratio` DECIMAL(18, 4) ,"
    "`peg_ratio` DECIMAL(18, 4) ,"
    "`pe_high` DECIMAL(18, 4) ,"
    "`pe_low` DECIMAL(18, 4) ,"
    "`depreciation` DECIMAL(18, 4) ,"
    "`changes_in_receviables` DECIMAL(18, 4) ,"
    "`changes_in_inventories` DECIMAL(18, 4) ,"
    "`cash_change` DECIMAL(18, 4) ,"
    "`cash_flow` DECIMAL(18, 4) ,"
    "`capital_expenditures` DECIMAL(18, 4) ,"
    "`investments` DECIMAL(18, 4) ,"
    "`total_investing_cash_flows` DECIMAL(18, 4) ,"
    "`dividends_paid` DECIMAL(18, 4) ,"
    "`net_borrowings` DECIMAL(18, 4) ,"
    "`other_cash_flows` DECIMAL(18, 4) ,"
    "`cash_flow_financing` DECIMAL(18, 4) ,"
    "`balance_sheet_date` DATE,"
    "`current_cash` DECIMAL(18, 4) ,"
    "`short_term_investments` DECIMAL(18, 4) ,"
    "`receivables` DECIMAL(18, 4) ,"
    "`inventory` DECIMAL(18, 4) ,"
    "`other_current_assets` DECIMAL(18, 4) ,"
    "`current_assets` DECIMAL(18, 4) ,"
    "`long_term_investments` DECIMAL(18, 4) ,"
    "`property_plant_equipment` DECIMAL(18, 4) ,"
    "`goodwill` DECIMAL(18, 4) ,"
    "`intangible_assets` DECIMAL(18, 4) ,"
    "`other_assets` DECIMAL(18, 4) ,"
    "`total_assets` DECIMAL(18, 4) ,"
    "`accounts_payable` DECIMAL(18, 4) ,"
    "`current_long_term_debt` DECIMAL(18, 4) ,"
    "`other_current_liabilites` DECIMAL(18, 4) ,"
    "`total_current_liabilites` DECIMAL(18, 4) ,"
    "`long_term_debt` DECIMAL(18, 4) ,"
    "`other_liabilites` DECIMAL(18, 4) ,"
    "`minority_interest` DECIMAL(18, 4) ,"
    "`total_liabilites` DECIMAL(18, 4) ,"
    "`common_stock` DECIMAL(18, 4) ,"
    "`retained_earnings` DECIMAL(18, 4) ,"
    "`treasury_stock` DECIMAL(18, 4) ,"
    "`capital_surplus` DECIMAL(18, 4) ,"
    "`shareholder_equity` DECIMAL(18, 4) ,"
    "`net_tangible_assets` DECIMAL(18, 4) ,"
    "`quick_ratio` DECIMAL(18, 4) ,"
    "`current_ratio` DECIMAL(18, 4) ,"
    "`total_debt_equity_ratio` DECIMAL(18, 4) ,"
    "`long_term_debt_equity` DECIMAL(18, 4) ,"
    "`short_term_debt_equity` DECIMAL(18, 4) ,"
    "`intangibles_book_ratio` DECIMAL(18, 4) ,"
    "`inventory_to_sales_ratio` DECIMAL(18, 4) ,"
    "`long_term_debt_percent_invest_cap` DECIMAL(18, 4) ,"
    "`short_term_debt_percent_invest_cap` DECIMAL(18, 4) ,"
    "`long_term_debt_to_total_debt` DECIMAL(18, 4) ,"
    "`short_term_debt_to_total_debt` DECIMAL(18, 4) ,"
    "`total_liabilites_to_total_assets` DECIMAL(18, 4) ,"
    "`working_capital` DECIMAL(18, 4) ,"
    "`sector` TEXT,"
    "`sub_sector` TEXT,"
    "`institutional_ownership` DOUBLE(14, 4) ,"
    "`short_interest_percent` DOUBLE(14, 4),"
    "`avg_30_volume` DOUBLE(14, 4) ,"
    "`mvg_avg_200` DOUBLE(14, 4) ,"
    "`mvg_avg_50` DOUBLE(14, 4) ,"
    "`max_change_percent` DOUBLE(14, 4) ,"
    "`year_5_change_percent` DOUBLE(14, 4) ,"
    "`year_2_change_percent` DOUBLE(14, 4) ,"
    "`year_1_change_percent` DOUBLE(14, 4) ,"
    "`ytd_change_percent` DOUBLE(14, 4) ,"
    "`month_6_change_percent` DOUBLE(14, 4) ,"
    "`month_3_change_percent` DOUBLE(14, 4) ,"
    "`month_1_change_percent` DOUBLE(14, 4) ,"
    "`day_30_change_percent` DOUBLE(14, 4) ,"
    "`day_5_change_percent` DOUBLE(14, 4) ,"
    "`resistance_point_avg` DOUBLE(14, 4),"
    "`resistance_point` DOUBLE(14, 4),"
    "`support_point` DOUBLE(14, 4),"
    "`support_point_avg` DOUBLE(14, 4),"
